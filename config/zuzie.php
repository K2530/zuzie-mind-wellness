...
return [
  ...
  [
    ...
    [
      ...
      'questions' => [
        [
          'text' => 'เลือกข้อที่ตรงกับคุณที่สุด',
          'options' => [
            'ฉันรู้สึกเศร้านานๆ ครั้ง',
            'ฉันรู้สึกเศร้าบ่อยครั้ง',
            'ฉันรู้สึกเศร้าตลอดเวลา',
          ],
          'text_en' => 'Choose the statement that best describes you',
          'options_en' => [
            'I feel sad for a long time. times',
            'I often feel sad',
        ...
        [
          ...
          'text_en' => 'Choose the statement that best describes you',
          'options_en' => [
            'Everything has obstacles.',
            'I\\'m not sure how things are. will go well',
            'Things will go well." It will go well for me.',
          ],
        ],
        [
          'text' => 'เลือกข้อที่ตรงกับคุณที่สุด',
