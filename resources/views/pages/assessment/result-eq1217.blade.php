            ...
            <div class="rounded-xl border border-reseda/15 bg-white p-6 shadow-sm sm:p-8">
              <div class="mb-6 flex items-center justify-between border-b border-reseda/15 pb-4">
                <div>
                  ...
                  <p class="mt-1 text-sm text-ink/70">ความพร้อมทางอารมณ์ที่จะอยู่ร่วมกับผู้อื่น (คะแนนรวม: {{ $totalGood }} / 64)</p>
                </div>
              </div>
              ...
              <div class="grid gap-6 sm:grid-cols-3">
                ...
                <!-- 1.2 เห็นใจผู้อื่น -->
                <div class="flex flex-col items-center rounded-lg bg-milk/50 p-5">
                  <h3 class="text-sm font-bold text-ink text-center h-10">1.2 เห็นใจผู้อื่น</h3>
                ...
                <!-- 1.3 รับผิดชอบ -->
                <div class="flex flex-col items-center rounded-lg bg-milk/50 p-5">
                  <h3 class="text-sm font-bold text-ink text-center h-10">1.3 รับผิดชอบ</h3>
            ...
            <div class="rounded-xl border border-reseda/15 bg-white p-6 shadow-sm sm:p-8">
              <div class="mb-6 flex items-center justify-between border-b border-reseda/15 pb-4">
                <div>
                  ...
                  <p class="mt-1 text-sm text-ink/70">ความพร้อมที่จะพัฒนาตนไปสู่ความสำเร็จ (คะแนนรวม: {{ $totalSmart }} / 64)</p>
                </div>
              </div>
              ...
              <div class="grid gap-6 sm:grid-cols-3">
                <!-- 2.1 มีแรงจูงใจ -->
                <div class="flex flex-col items-center rounded-lg bg-milk/50 p-5">
                  <h3 class="text-sm font-bold text-ink text-center h-10">2.1 มีแรงจูงใจ</h3>
                ...
                <!-- 2.3 สัมพันธภาพ -->
                <div class="flex flex-col items-center rounded-lg bg-milk/50 p-5">
                  <h3 class="text-sm font-bold text-ink text-center h-10">2.3 สัมพันธภาพ</h3>
            ...
            <div class="rounded-xl border border-reseda/15 bg-white p-6 shadow-sm sm:p-8">
              <div class="mb-6 flex items-center justify-between border-b border-reseda/15 pb-4">
                <div>
                  ...
                  <p class="mt-1 text-sm text-ink/70">ความพร้อมทางอารมณ์ที่ทำให้เกิดความสุข (คะแนนรวม: {{ $totalHappy }} / 64)</p>
                </div>
              </div>
              ...
              <div class="grid gap-6 sm:grid-cols-3">
                ...
                <!-- 3.2 พอใจชีวิต -->
                <div class="flex flex-col items-center rounded-lg bg-milk/50 p-5">
                  <h3 class="text-sm font-bold text-ink text-center h-10">3.2 พอใจชีวิต</h3>
            ...
            <div class="mt-5 grid gap-4">
              <div class="rounded-lg border border-reseda/10 bg-milk p-4">
                ...
                <ul class="mt-2 grid gap-1 text-sm leading-6 text-ink/70">
                  <li><strong class="text-ink">3.1 ภูมิใจตนเอง:</strong> ปกติ 9-13</li>
                  <li><strong class="text-ink">3.2 พอใจชีวิต:</strong> ปกติ 16-22</li>
                  <li><strong class="text-ink">3.3 สุขสงบทางใจ:</strong> ปกติ 15-21</li>
                </ul>
              </div>
              ...
              <div class="rounded-lg border border-reseda/10 bg-milk p-4">
                ...
                <ul class="mt-2 grid gap-1 text-sm leading-6 text-ink/70">
                  <li><strong class="text-ink">2.1 มีแรงจูงใจ:</strong> ปกติ 20-25</li>
              ...
              <div class="rounded-lg border border-reseda/10 bg-milk p-4">
                ...
                <ul class="mt-2 grid gap-1 text-sm leading-6 text-ink/70">
                  ...
                  <li><strong class="text-ink">3.2 พอใจชีวิต:</strong> ปกติ 15-20</li>
