    ...
    <div class="mx-auto max-w-7xl px-5 sm:px-10">
      ...
      <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <article class="soft-card overflow-hidden">
          ...
          <div class="p-5">
            <p class="text-sm text-ink/65">แบบประเมินสำหรับเด็ก</p>
            <h3 class="mt-1 text-xl font-bold">คัดกรองพัฒนาการเด็กปฐมวัย (DSPM)</h3>
            <p class="mt-3 min-h-14 text-sm leading-6 text-ink/70">ประเมินและคัดกรองพัฒนาการเด็กแรกเกิด - 60 เดือน เพื่อดูพัฒนาการรายด้าน</p>
            <a href="{{ route('dspm.index') }}" class="btn-secondary mt-4 w-full">เริ่มทำแบบประเมิน</a>
          </div>
        </article>
<article class="soft-card overflow-hidden">
          <img src="{{ asset('assets/images/hero-woman-tea.webp') }}" alt="" class="h-36 w-full object-cover object-[68%_45%]">
