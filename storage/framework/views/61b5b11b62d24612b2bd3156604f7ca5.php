                  ...
                  <div class="mt-4 grid gap-2 sm:grid-cols-4">
                    <?php $__currentLoopData = [0 => 'ไม่เลย', 1 => 'เล็กน้อย', 2 => 'บ่อยครั้ง', 3 => 'มากที่สุด']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <label class="flex gap-2 min-h-14 w-full cursor-pointer items-center justify-center rounded-md border border-reseda/15 bg-white px-3 py-2 text-center text-sm font-semibold text-ink/72 transition hover:border-reseda hover:bg-almond/55">
                        <input type="radio" name="answers[<?php echo e($index); ?>]" value="<?php echo e($value); ?>" required <?php if((string) old("answers.$index") === (string) $value): echo 'checked'; endif; ?> class="accent-reseda w-4 h-4">
                        <?php echo e($label); ?>
